...
| Complexity | Exa | Metaso | Brave | GitHub |
|------------|-----|--------|-------|--------|
| Quick | 2000-3000 | 5 | 5 | 5 |
| Regular | 5000 | 10 | 10 | 10 |
| Deep | 8000+ | 20 | 20 | 50 |
...
- **v2.0.0** (2026-01-28): Replace Bocha with Brave Search, add source attribution
- **v1.3.0** (2026-01-17): Optimized structure, added bilingual README
- **v1.2.1** (2026-01-17): Adjust default values
