...
|--------|---------|----------|------------|
| P0 | **Exa** | 代码搜索、英文文档、API参考 | 代码、编程、API、函数、框架、library、tutorial、example、syntax、bug |
| P1 | **Metaso** | 学术搜索、AI总结、深度研究 | 学术、论文、research、study、期刊、文献、引用 |
| P2 | **Bocha** | 中文资讯、时间过滤、极速搜索 | 今天、本周、最新、最近、news、时间范围 |
| P3 | **GitHub** | 仓库操作、Issue管理、PR审查 | github、仓库、issue、PR、commit、分支 |
